...
namespace SuperBMD.Util.Json {
    class Matrix2x3Json : JsonConverter {
    ...
    class Vector2Json : JsonConverter {
        public override bool CanConvert(Type objectType) {
    ...
    class Vector3Json : JsonConverter {
        public override bool CanConvert(Type objectType) {
    ...
    class Matrix4Json : JsonConverter {
        public override bool CanConvert(Type objectType) {
